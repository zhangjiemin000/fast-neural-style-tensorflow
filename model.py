...
def net(image, training):
    ...
    with tf.variable_scope('deconv1'):
        ...
        deconv1 = relu(instance_norm(resize_conv2d(res3, int(32*alpha), int(32*alpha), 3, 2, training)))  #重新resize大小的卷积网络
    ...
    with tf.variable_scope('deconv3'):
        ...
        deconv3 = tf.nn.tanh(instance_norm(conv2d(deconv1, int(32*alpha), 3, 9, 1)))
    y = (deconv3 + 1) * 127.5
